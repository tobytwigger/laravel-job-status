import { d as commonjsGlobal, b as QSeparator, c as client$1, Q as QBreadcrumbsEl, a as QBreadcrumbs } from "./index.203c0d01.js";
import { g as getBtnDesignAttr, Q as QBtn } from "./QBtn.f8ceaf0c.js";
import { c as createComponent, h as hSlot, e as hMergeSlot, b as createDirective, a as hUniqueSlot, d as hDir } from "./render.060e8dc4.js";
import { c as computed, h, j as emptyRenderFn, r as ref, k as onBeforeUnmount, o as onMounted, a as inject, D as withDirectives, a2 as tabsKey, q as stopAndPrevent, Y as isKeyCode, a3 as shouldIgnoreKey, g as getCurrentInstance, a4 as isDeepEqual, Z as onDeactivated, n as nextTick, w as watch, a5 as onActivated, E as provide, m as client, u as noop, v as leftClick, x as addEvt, y as preventDraggable, B as position, C as cleanEvt, X as Transition, a6 as KeepAlive, a7 as timelineKey, _ as _export_sfc, K as defineComponent, L as openBlock, S as createElementBlock, F as Fragment, U as renderList, M as createBlock, N as withCtx, Q as toDisplayString, R as createBaseVNode, a0 as unref, P as createTextVNode, O as createCommentVNode, d as createVNode } from "./index.9f6f356f.js";
import { u as useTimeout, Q as QResizeObserver, g as getModifierDirections, s as shouldStart, c as clearSelection, a as QBanner } from "./QBanner.82512254.js";
import { u as useDarkProps, a as useDark, d as QList, c as QItem, Q as QItemSection, b as QItemLabel } from "./QItem.8ac5cbd8.js";
import { R as Ripple, Q as QIcon, i as vmIsDestroyed, j as getNormalizedVNodes, d as useAlignProps, f as useAlign, k as getParentProxy } from "./use-router-link.52590381.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    let listener = client$1.runs.show(props.jobStatusId).listen().onUpdated((newResults) => results.value = newResults).start();
    onBeforeUnmount(() => {
      listener.stop();
    });
    ...
    function cancel() {
      ...
      client$1.runs.cancel(props.jobStatusId).send().finally(() => cancelling.value = false);
    }
    const retrying = ref(false);
    function retry() {
      retrying.value = true;
      client$1.runs.retry(props.jobStatusId).send().finally(() => retrying.value = false);
    }
