...
class QueueIndexTest extends TestCase
{
    ...
    {
        $job1 = JobStatus::factory(['queue' => 'OurQueue', 'public' => true])->count(5)->create();
        $job2 = JobStatus::factory(['queue' => 'OurQueueTwo', 'public' => true])->count(5)->create();
    ...
    {
        $inaccessible = JobStatus::factory(['queue' => 'OurQueue', 'public' => false])->count(10)->create();
        $accessible = JobStatus::factory(['queue' => 'OurQueueTwo', 'public' => true])->count(10)->create();
        ...
        $result->assertFragment(['queue' => 'OurQueueTwo']);
        ...
        $result->assertMissing(['queue' => 'OurQueue']);
    ...
    {
        $job1 = JobStatus::factory(['queue' => 'OurQueue', 'public' => true])->count(5)->create();
        $job2 = JobStatus::factory(['queue' => 'OurQueueTwo', 'public' => false])->count(5)->create();
        ...
        $response->decodeResponseJson()->assertFragment(['id' => $job1[3]->id]);
        $response->decodeResponseJson()->assertFragment(['id' => $job1[4]->id]);
        $response->decodeResponseJson()->assertMissing(['queue' => 'OurQueueTwo']);
    }
    ...
    public function it_gives_access_to_a_private_job_to_a_dashboard_user()
    {
        ...
        $result->assertFragment(['queue' => 'OurQueue']);
