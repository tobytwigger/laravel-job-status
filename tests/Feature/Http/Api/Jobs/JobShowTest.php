...
class JobShowTest extends TestCase
{
    ...
    public function it_returns_the_requested_job()
    {
        ...
        $status = JobStatus::factory()->create(['is_unprotected' => false, 'alias' => 'Job 1']);
        ...
        $this->assertEquals($status->class, $result['class'] ?? null);
        $this->assertEquals($status->alias, $result['alias'] ?? null);
    }
    ...
    public function it_only_searches_by_alias()
    {
        ...
        $status = JobStatus::factory()->create(['is_unprotected' => false, 'alias' => 'Job 1', 'class' => 'MyJobClass']);
    ...
    public function it_returns_a_200_if_the_user_does_not_have_access_to_a_public_run_through_the_job()
    {
        ...
        $status = JobStatus::factory()->create(['is_unprotected' => true, 'alias' => 'Job 1', 'class' => 'MyJobClass']);
